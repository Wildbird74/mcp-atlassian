...
| `jira_agile` | No | `jira_get_agile_boards`, `jira_get_board_issues`, `jira_get_board_backlog`, `jira_get_sprints_from_board`, `jira_get_sprint_issues`, `jira_create_sprint`, `jira_update_sprint`, `jira_add_issues_to_sprint`, `jira_move_issues_to_backlog` |
